...
% -------------------------------------------
\section{Przyjęte wartości stałe}
% -------------------------------------------
...
\begin{itemize}
    \item Ciepło właściwe wody: $c_w = \qty{4187}{\joule\per\kilogram\per\kelvin}$,
    \item Ciepło właściwe aluminium: $c_{Al} = \qty{897}{\joule\per\kilogram\per\kelvin}$.
\end{itemize}
...
również potrzebne jest ciepło właściwe wody, które przyjęto jako $c_w =
    \qty{4187}{\joule\per\kilogram\per\kelvin}$.
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item zewnętrzna część kalorymetru wykonana z aluuminium,
        \item pokrywka wykonana z plastiku z otworami na termometr i mieszadełko,
    ...
    \item kostki lodu z zamrażarki w temperaturze \qty{0}{\degreeCelsius}
\end{itemize}
...
\begin{equation}
    q_t = \qty{325784 \pm 3433}{\joule\per\kilogram}
        \approx \qty[separate-uncertainty=true]{326(3)}{\kilo\joule\per\kilogram}.
    \label{eq:qt_wynik}
\end{equation}

...
% -------------------------------------------
Celem ćwiczenia jest zweryfikowanie praw ruchu obrotowego bryły sztywnej poprzez rozpędzanie wahadła Oberbecka za pomocą ciężarków i badania czasu przelotu ciężarków przez fotokomórkę. Na podstawie pomiarów czasu przelotu ciężarków przez fotokomórkę, można obliczyć prędkość kątową wahadła, wyznaczyć moment bezwładności układu i zweryfikować zadane zależności.
...
\end{equation}
Najprostszym przypadkiem ruchu obrotowego jest obrót bryły sztywnej dookoła ustalonej osi. Wtedy wektory momentu siły $\vec{N}$, prędkości kątowej $\vec{\omega}$ oraz momentu pędu $\vec{L} = J_{(O)}\vec{\omega}$ są do siebie równoległe i powiązane poprzez równanie ruchu:
\begin{equation}
...
Najczęściej moment bezwładności można łatwo obliczyć względem osi przechodzącej przez środek masy ciała. Dla określenia momentu bezwładności względem innej osi pomocne jest \textit{twierdzenie o osiach równoległych} (twierdzenie Steinera).
...
Wahadło Oberbecka jest bryłą sztywną obracającą się wokół poziomej osi, składającą się z prostopadłych do siebie par ramion. Do ramion można przyczepić ciężarki w kształcie walca (masa $M_W$, promień $R_W$, wysokość $H_W$). Moment bezwładności takiego walca względem osi przechodzącej przez jego środek masy, prostopadłej do osi symetrii walca, wynosi (wzór~\ref{eq:cylinder_perp}):
\[
...
\begin{itemize}
    \item wahadło Oberbecka z możliwością montażu ciężarków walcowych
    \item zestaw ciężarków walcowych o różnych masach, promieniach i wysokościach
    \item ciężarki do zawieszenia na nitce
    \item fotokomórki do pomiaru czasu przelotu ciężarków
    \item linijka i suwmiarka do pomiaru wymiarów ciężarków i odległości
    \item waga elektryczna AXIS B2 o zakresie pomiarowym do \qty{2000}{\gram} i dokładności \qty{0.1}{\gram}.
    \item taśma miernicza do pomiaru odległości między fotokomórkami o dokładności \qty{1}{\mm}
    \item suwmiarka do pomiaru odległości ciężarków walcowych od osi obrotu o dokładności \qty{0.1}{\mm}
\end{itemize}
% -------------------------------------------
\section{Procedura pomiarowa}
% -------------------------------------------
\subsection{Zależność kwadratu czasu przelotu od odległości fotokomórek}
Procedurę pomiarową należy powtórzyć kilkukrotnie dla różnych odległości fotokomórek, przy stałej masie ciężarków zawieszonych na nitce i braku ciężarków walcowych na ramionach wahadła:
\begin{enumerate}
    \item Ustawić fotokomórki w wybranej odległości od siebie.
    \item Zawiesić na nitce ciężarki o stałej masie $m$.
    \item Ustawić ciężarek ponad górną fotokomórką.
    \item Powoli obracać wahadło aż do momentu, w którym ciężarek aktywuje fotokomórkę.
    \item Cofnąć ciężarek do pozycji startowej i wyzerować fotokomórkę.
    \item Zwolnić wahadło i pozwolić na swobodny spadek ciężarka, rejestrując czas przelotu między fotokomórkami.
    \item Powtórzyć pomiar kilka razy dla tej samej odległości fotokomórek i obliczyć średni czas przelotu.
    \item Powtórzyć całą procedurę dla różnych odległości fotokomórek, zachowując stałą masę ciężarków zawieszonych na nitce.
\end{enumerate}
\subsection{Zależność kwadratu czasu przelotu od kwadratu odległości ciężarków od osi obrotu}
Procedurę pomiarową należy powtórzyć kilkukrotnie dla różnych odległości ciężarków walcowych od osi obrotu, przy stałej masie ciężarków zawieszonych na nitce i stałej odległości fotokomórek:
\begin{enumerate}
    \item Ustawić fotokomórki w stałej odległości od siebie.
    \item Zawiesić na nitce ciężarki o stałej masie $m$.
    \item Umieścić ciężarki walcowe na ramionach wahadła w wybranej odległości $d_W$ od osi obrotu symetrycznie po obu stronach.
    \item Ustawić ciężarek ponad górną fotokomórką.
    \item Powoli obracać wahadło aż do momentu, w którym ciężarek aktywuje fotokomórkę.
    \item Cofnąć ciężarek do pozycji startowej i wyzerować fotokomórkę.
    \item Zwolnić wahadło i pozwolić na swobodny spadek ciężarka, rejestrując czas przelotu między fotokomórkami.
    \item Powtórzyć pomiar kilka razy dla tej samej odległości ciężarków walcowych od osi obrotu i obliczyć średni czas przelotu.
    \item Powtórzyć całą procedurę dla różnych odległości ciężarków walcowych od osi obrotu, zachowując stałą masę ciężarków zawieszonych na nitce i stałą odległość fotokomórek od siebie.
\end{enumerate}
\subsection{Zależność kwadratu czasu przelotu od odwrotności masy ciężarków zawieszonych na nitce}
\begin{enumerate}
    \item Ustawić fotokomórki w stałej odległości od siebie.
    \item Zawiesić na nitce ciężarki o wybranej masie $m$.
    \item Ustawić ciężarek ponad górną fotokomórką.
    \item Powoli obracać wahadło aż do momentu, w którym ciężarek aktywuje fotokomórkę.
    \item Cofnąć ciężarek do pozycji startowej i wyzerować fotokomórkę.
    \item Zwolnić wahadło i pozwolić na swobodny spadek ciężarka, rejestrując czas przelotu między fotokomórkami.
    \item Powtórzyć pomiar kilka razy dla tej samej masy ciężarków zawieszonych na nitce i obliczyć średni czas przelotu.
    \item Powtórzyć całą procedurę dla różnych mas ciężarków zawieszonych na nitce, zachowując stałą odległość fotokomórek od siebie.
\end{enumerate}
...
\begin{figure}[H]
    ...
    \caption{Surowe pomiary $t^2$ w funkcji odległości bramek $h$ dla czterech serii pomiarowych.}\label{fig:surowe_h}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Surowe pomiary $t^2$ w funkcji $r_W^2$ dla czterech odległości ciężarków walcowych od osi obrotu.}\label{fig:surowe_dw2}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Surowe pomiary $t^2$ w funkcji $1/m$ dla czterech mas ciężarków zawieszonych na nitce.}\label{fig:surowe_m}
\end{figure}
...
Przy stałej odległości bramek $h_2 = \qty{30.0 \pm 0.1}{\cm}$ i stałej masie szalki $m_2$ moment bezwładności ciężarków $J_W = J_{W,0} + M_W r_W^2$ (twierdzenie Steinera), skąd model liniowy:
\begin{equation}
